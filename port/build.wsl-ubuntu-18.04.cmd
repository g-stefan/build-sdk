...
exit 1
:cmdBuildCheck
if exist "..\%1\port\build.wsl-ubuntu-18.04.cmd" goto :cmdBuildRun
echo "Error - not found: ..\%1\port\build.wsl-ubuntu-18.04"
exit 1
:cmdBuildRun
pushd "..\%1"
cmd.exe /C ".\port\build.wsl-ubuntu-18.04 %ACTION%"
