...
exit 1
:cmdBuildCheck
if exist "..\%1\port\build.wsl-ubuntu-20.04.cmd" goto :cmdBuildRun
echo "Error - not found: ..\%1\port\build.wsl-ubuntu-20.04.cmd"
exit 1
:cmdBuildRun
pushd "..\%1"
cmd.exe /C ".\port\build.wsl-ubuntu-20.04 %ACTION%"
...
for /F "eol=# tokens=1" %%i in (.\source\ubuntu.txt) do call :build %%i
